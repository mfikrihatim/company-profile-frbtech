        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <?php
                    //create form
                    $attributes = array('id' => 'FrmAddPortofolio', 'method' => "post", "autocomplete" => "off");
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_portofolio" name="nama_portofolio" value=" <?= set_value('nama_portofolio'); ?>">
